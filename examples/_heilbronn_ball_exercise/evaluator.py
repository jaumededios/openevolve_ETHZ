...
def plot_points(points: np.ndarray, min_area: float, witness: tuple) -> str:
    """
    Helper function: Plot points with the witness triangle highlighted and return the PNG as base64.
    Then you can see what the code does and "debug"
    """
...
def evaluate(program_path):
    try:
        ...
        return EvaluationResult(
                ...
                artifacts={
                   #optionally you can use "base64plot": plot_points(points, area, witness)
                }
            )
